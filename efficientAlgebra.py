...
def removeLeadingZeros(a):
    '''
    removes all leading 0's of a string, ignores any occurence of '-' (so also removes 0's after '-')
...
def add(x, y, r):
    ...
    #add individual charactrers and store a carry
...
def subtract(x, y, r):
    ...
    #substract individual charactrers and store a carry
    for i in range(length):
